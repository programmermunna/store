            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                  ...
                  $result = mysqli_query($conn,"SELECT Orders.*, user_info.* FROM orders INNER JOIN user_info ON Orders.user_id=user_info.id WHERE status='Pending' LIMIT $offset, $total_records_per_page");
                  while($data= mysqli_fetch_assoc($result)){?>
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo $data['pmn_method'];?></span>
                      </td>
                      ...
                      <td style="text-align:center">
                        ...
                        <a href="delete.php?src=pending-orders&&id=<?php echo $data['id'];?>" class="text-secondary font-weight-bold text-xs">Delete</a>
                      </td>
                    </tr>
                    <?php }?>
                  </tbody>
