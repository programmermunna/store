        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div style="display:flex;justify-content:space-between" class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  if(isset($_POST['search'])){
                    ...
                    $sql = "SELECT orders.*, admin_info.* FROM orders INNER JOIN admin_info ON orders.user_id=admin_info.id WHERE (name='$src_text' OR email='$src_text' OR address='$src_text' OR pmn_method='$src_text' OR pmn_number='$src_text' OR trans_id='$src_text' OR years_num='$src_text' OR amount='$src_text') AND orders.status='Success'";
