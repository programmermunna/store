                    ...
                    <header class="table_header">
                        ...
                        <form action="" method="POST">
                            <div class="table_header_right">
                                <input type="search" name="src_text" placeholder="Search Seller" />
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table_th"><div class="table_th_div"><span>Shop</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>Ac_holder</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>Ac_number</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>Bank</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>branch</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>City</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>Photo</span></div></th>
                                ...
                                if(isset($_POST['search'])){
                                    ...
                                    $sql = "SELECT * FROM seller WHERE name = '$src_text' OR email = '$src_text' OR phone = '$src_text' OR address = '$src_text' OR shop = '$src_text' OR ac_holder = '$src_text' OR ac_number = '$src_text' OR bank = '$src_text' OR branch = '$src_text' OR city = '$src_text'";
                                 ...
                                 if(isset($search_query)){
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['shop']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['ac_holder']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['ac_number']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['bank']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['branch']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['city']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><img class="row_img" src="upload/<?php echo $row['file']?>"></div></td>
                                        <td class="p-3 border whitespace-nowrap">
                                            <div class="w-full flex_center gap-1">
                                            <a class="btn table_edit_btn" href="seller-edit.php?id=<?php echo $row['id']?>">Edit</a>
                                            <a class="btn table_edit_btn" href="seller-delete.php?id=<?php echo $row['id']?>">Delete</a>
                                                <a class="btn table_edit_btn" href="seller-view.php?id=<?php echo $row['id']?>">View</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php }}else{
                                ...
                                $totalEmpSQL = "SELECT * FROM seller ORDER BY id DESC";
                                ...
                                $empSQL = "SELECT * FROM seller ORDER BY id DESC LIMIT $startFrom, $showRecordPerPage";
                                ...
                                $i=0; while($row = mysqli_fetch_assoc($query )){ $i++ ?>
                                    <tr>
                                        ...
                                        <td class="p-3 border whitespace-nowrap">
                                            <div class="w-full flex_center gap-1">
                                            <a class="btn table_edit_btn" href="seller-edit.php?id=<?php echo $row['id']?>">Edit</a>
                                            <a class="btn table_edit_btn" href="delete.php?src=seller&&id=<?php echo $row['id']?>">Delete</a>
                                                <a class="btn table_edit_btn" href="seller-view.php?id=<?php echo $row['id']?>">View</a>
                                            </div>
                                        </td>
                                    </tr>
