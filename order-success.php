                    ...
                    <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table_th"><div class="table_th_div"><span>Order Id</span></div></th>
                                ...
                                if(isset($_POST['search'])){
                                    ...
                                    $sql = "SELECT tmp_product.*,customer.* FROM tmp_product INNER JOIN customer ON tmp_product.customer_id=customer.id WHERE (customer.name = '$src_text' OR customer.email = '$src_text' OR tmp_product.order_no = '$src_text') AND tmp_product.status='Success' ORDER BY  tmp_product.id DESC";
                                ...
                                while($row = mysqli_fetch_assoc($query)){ $i++;
                                 ...
                                 ?>
                                    <tr>
                                        ...
                                        <td class="p-3 border whitespace-nowrap">
                                            <div class="w-full flex_center gap-1">
                                                <a class="btn table_edit_btn" href="pos-invoice.php?order=<?php echo $row['order_no']?>&&customer=<?php echo $row['customer_id']?>&&status=Success">Invoice</a>
                                            </div>
                                        </td>
                                    </tr>
                              <?php  } ?>
