                    ...
                    <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table_th"><div class="table_th_div"><span>code</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>brand</span></div></th>
                                        <th class="table_th"><div class="table_th_div"><span>category</span></div></th>
                                ...
                                if(isset($_POST['search'])){
                                 ...
                                 if(isset($search_query)){
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['product_name']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['sell_price']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['product_code']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['brand']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['category']?></div></td>
                                        <td class="p-3 border whitespace-nowrap"><div class="text-center"><?php echo $row['date']?></div></td>
