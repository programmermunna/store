...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO employee(admin_id,name,email,phone,address,salary,file,time) VALUES($id,'$name','$email','$phone','$address','$salary','$file_name','$time')";
    $query = mysqli_query($conn,$sql);
    if($query){
    $msg = "Successfully Created New employee!";
                ...
                <div class="table_content_wrapper">
                    ...
                    <header class="table_header">
                        <div class="table_header_left">
                            <button
                                class="add_brand_btn show_add_new_cat px-4 py-2 text-sm bg-blue-600 text-white rounded focus:ring">Add Employee</button>
                        </div>
                        <form action="" method="POST">
                            <div class="table_header_right">
                                <input type="search" name="src_text" placeholder="Search emloyee" />
                        ...
                        <div class="table_sub_parent">
                            <table class="table">
                                ...
                                if(isset($_POST['search'])){
                                    ...
                                    $sql = "SELECT * FROM employee WHERE name = '$src_text' OR email = '$src_text' OR phone = '$src_text' OR address = '$src_text' OR salary = '$src_text' AND admin_id=$id";
                                 ...
                                 if(isset($search_query)){
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3 border whitespace-nowrap">
                                            <div class="text-center"><?php echo $row['salary']?>৳</div>
                                        </td>
                                        <td class="p-3 border whitespace-nowrap">
                                        ...
                                        <td class="p-3 border whitespace-nowrap">
                                            <div class="w-full flex_center gap-1">
                                                <a class="btn table_edit_btn"
                                                    href="employee-edit.php?id=<?php echo $row['id']?>">Edit</a>
                                                <a class="btn table_edit_btn"
                                                    href="delete.php?src=employee&&id=<?php echo $row['id']?>">Delete</a>
                                                <a class="btn table_edit_btn"
                                                    href="employee-view.php?id=<?php echo $row['id']?>">View</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php }}else{
                                ...
                                $totalEmpSQL = "SELECT * FROM employee WHERE admin_id=$id ORDER BY id DESC";
                                ...
                                $empSQL = "SELECT * FROM employee WHERE admin_id=$id ORDER BY id DESC LIMIT $startFrom, $showRecordPerPage";
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="add_category_wrapper add_brand" style="display: none;">
            ...
            <div
                ...
                <div>
                    <label>salary</label>
                    <input type="text" name="salary" placeholder="salary" class="input" />
                </div>
                <div>
                    <label>Photo</label>
                    <input type="file" name="file" title="profile" placeholder="salary" />
                </div>
                ...
                <div class="p-4 flex items-center justify-end gap-x-3 border-t mt-4">
                    <button class="btn w-fit p-2 bg-blue-600 text-white rounded focus:ring-2" type="submit"
                        name="submit">Create Employee</button>
                    <button
