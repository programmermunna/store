                ...
                <div style="display:flex; justify-content: space-between;" class="page_title">
                    ...
                    <table class="table">
                                ...
                                if(isset($_POST['search'])){
                                    ...
                                    $sql = "SELECT tmp_product.*,customer.* FROM tmp_product INNER JOIN customer ON tmp_product.customer_id=customer.id WHERE (customer.name = '$src_text' OR customer.email = '$src_text' OR tmp_product.order_no = '$src_text') tmp_product.admin_id=$id AND tmp_product.status='Pending' ORDER BY  tmp_product.id DESC";
